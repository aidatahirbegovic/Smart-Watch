...
U8GLIB_SSD1306_128X64 u8g (10, 9, 12, 11 ,13);//Arduino Pro Mini, Ekran baglantisi
...
PROGMEM const char* const weekString[] = {"", "Pazar", "Pazartesi", "Sali", "Carsamba", "Persembe", "Cuma", "Cumartesi"};
PROGMEM const char* const ampmString[] = {"", ""};
///////////////////////////////////////////////////////////////////
...
PROGMEM const char* const strIntro[] = {"IOT", "Projesi", "Aida ve Ahmed"};
///////////////////////////////////////////////////////////////////
...
void setTimeValue() {
  iMonth = timeBuffer[0];
  iDay = timeBuffer[1];
  iWeek = timeBuffer[2];    // 1: PAZ, PTS, SAL, CAR, PER, CUM, CTS
